...
Протокол: `references/methodology/intestinal_health.md` ⭐ (микрофлора, СИБР, желчеотток, сладкая зависимость — урок 4)
Протокол: `references/methodology/digestion_basics.md` ⭐ (основы пищеварения, дневник — урок 1)
Выжимка: `references/01_digestion_gastro.md` (раздел «Кишечник») (DEPRECATED — мигрирует в Протокол)
