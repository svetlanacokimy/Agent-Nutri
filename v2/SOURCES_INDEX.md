...
Протокол: `references/methodology/skin_hair_health.md` ⭐ (акне, розацеа, демодекоз, атопический дерматит, коллаген, выпадение волос, ногти — уроки 20, 24, 07)
Выжимка: `references/07_hormones_skin_hair.md` (DEPRECATED — частично мигрировал в Протокол)
...
## Урогенитальные инфекции, кандидоз, пигментация

Протокол: `references/methodology/urogenital_infections.md` ⭐ (цистит рецидивирующий/интерстициальный, кандидоз вагинальный/кишечный/системный, мелазма/хлоазма — урок 23, файл 07)
Первичный: `text_extracted/УРОК 23. Цистит. Кандидоз. Пигментация.txt`
...
Протокол: `references/methodology/lymph_immune.md` ⭐ (лимфостаз, дренаж, иммуноглобулины, Т/В-клетки, поддержка иммунитета — урок 24, файл 07)
Первичный: `text_extracted/УРОК 24. Выпадение волос. Лимфатическая и иммунная системы.txt`
...
Протокол: `references/methodology/nervous_system.md` ⭐ (ВНС, ось HPA, кортизол, сон, мигрень, тревога/депрессия — уроки 25, 08)
Выжимка: `references/08_autoimmune_neuro.md` (DEPRECATED — частично мигрировал в Протокол)
...
Протокол: `references/methodology/menus.md` ⭐ (7 типов лечебных меню: безмолочное, вегетарианское, АИП, антипаразитарное, 1300 ккал, при запорах/диарее, при СД/ИР)
Выжимка: `references/02_nutrition_basics.md` (DEPRECATED — мигрирует в Протокол)
Выжимка: `references/12_menus.md` (остаётся как источник шаблонов меню)
...
Протокол: `references/methodology/nutraceuticals.md` ⭐ (классификация, безопасность, взаимодействия с лекарствами, запреты при АИЗ/беременности, красные флаги — урок 28, файл 09)
Выжимка: `references/09_nutraceuticals.md` (остаётся активным как справочник по конкретным БАД)
Первичный: `text_extracted/УРОК 28. Нутрицевтики.txt`
Связанные ссылки на покупку: `text_extracted/Ссылки БАД.txt`

---

## Суставы и остеопороз

Протокол: `references/methodology/joints_osteoporosis.md` ⭐ (остеоартроз, остеопороз, воспалительные артропатии в обзоре; нутритивная поддержка кости/хряща — Ca, D, K2, Mg, белок, коллаген, омега-3; DEXA/FRAX в обзоре, красные флаги — урок 26, Кластер 19)
Первичный: `text_extracted/УРОК 26. Тонзиллит. Суставы. Остеопороз.txt`
Ключевые EBM-источники: WHO 1994, NOF 2022, IOF, ISCD 2019, ESCEO/Rizzoli 2018, VITAL/Manson 2019, Knapen 2013, GAIT 2006, EULAR 2003, Kellgren–Lawrence 1957, Zdzieblik 2017, König 2018, Kuptniratsaikul 2014, Chilibeck 2017, ACR/EULAR 2010, Bolland 2010
(тонзиллит — отдельной выжимки нет, общее знание)

---

## COVID, подготовка к беременности

Протокол: `references/methodology/covid_pregnancy.md` ⭐ (постковидный синдром, лабораторная панель, восстановление; прегравидарная подготовка — 3 стадии, лабпанель ♀/♂, MTHFR, спермограмма — уроки 27, 08)
...
Таблица: `references/methodology/tables/unit_conversions.md` ⭐ (12 таблиц пересчёта: глюкоза, липиды, гормоны, витамины, минералы, ферменты, гематология; клинические примеры, red-flags, чек-лист)
...
- **PARTIAL_EBM — 8 файлов (15.1 %):** `covid_pregnancy.md`, `female_hormones.md`, `gallbladder_health.md`, `nervous_system.md`, `pancreas_health.md`, `stress_adrenals.md`, `vitamins.md`.
...
- Суставы / остеопороз — ✅ плановый протокол `joints_osteoporosis.md` создан (Session 39, Кластер 19); см. раздел «Суставы и остеопороз».
